 ...
 */
final class Version20231023122704 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE client ADD CONSTRAINT FK_C74404554887F3F8 FOREIGN KEY (shipping_id) REFERENCES address (id)');
